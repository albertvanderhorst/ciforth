...
;
	...
	DB	'E'+80H
	DW	SEMIS-5
LLEAVE   DW      $-$$+2     ;LIMIT <- INDEX
	MOV	AX,[BP]	;GET INDEX
	MOV	[2+BP],AX        ;STORE IT ATAT LIMIT
	JMP     NEXT
;
;	>R
;
...
;	PC!
;
; STORE CHARACTER (BYTE) ATAT PORT
;
	DB	83H
	DB	'PC'
	DB	'!'+80H
