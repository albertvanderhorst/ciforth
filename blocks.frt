...
DECIMAL
( GET-SEL PUT-SEL read_and_write_DPMI_selectors) ?WI
HEX
...
: GET-ALIAS  0A SWAP 0 0 0 BIOS31A 1 AND 0D ?ERROR 2DROP DROP ;
\ Get a SELECTOR to BUFFER
: GET-SEL   >R 0B SWAP 0 0 R> BIOS31A 1 AND 0D ?ERROR
2DROP 2DROP ;
\ Install a SELECTOR from BUFFER
: PUT-SEL   >R 0C SWAP 0 0 R> BIOS31A 1 AND 0D ?ERROR
2DROP 2DROP ;
