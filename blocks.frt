...
( ASSSEMBLER 16 BIT REAL ELECTIVES A0JUL04 AH)
 ?16
 121 124 HEX THRU  DECIMAL ( Common code , prelude)
 92 HEX LOAD DECIMAL ( Only real indexing)
...
[SP]' [BP]' [SI]' [DI]'
( 3F) 00 1PI SIB|' ( COMBINES WITH D0| DB| DX| )
( 0) 0 1PI SIB,'
( C0) 40 0 4 1FAMILY| +1*| +2*| +4*| +8*|
( Example : AS: MOVI, X| D0| SIB|' SIB,' AX| +1*| SI|   117 X, )
...
: SPLIT2 SPLIT SPLIT ; ( To handle two bytes at once )
