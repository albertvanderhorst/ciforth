...
HEX
: 1PI <BUILDS  , FFFFFF00 OR , INVERT , DOES> <POST POST, 1 CORRECT ;
: 2PI <BUILDS  , FFFF0000 OR , INVERT , DOES> <POST POST, 2 CORRECT ;
: 3PI <BUILDS  , FF000000 OR , INVERT , DOES> <POST POST, 3 CORRECT ;
DECIMAL
...
00 30 T! 00 10 4 xFAMILY| BC| DE| HL| SP|
...
00 38 T! 00 01 8 xFAMILY| B'| C'| D'| E'| H'| L'| M'| A'| ( dst)
