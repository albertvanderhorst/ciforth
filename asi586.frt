...
0280 00,0000 0700,0001 0500,0000 xFIR [BP   ( Fits in the hole, safe inconsistency check)
0240 02,0000 0700,0001 0500,0000 xFIR [MEM  ( Fits in the hole, safe inconsistency check)
...
0120 01,0000 0700,0000 0400,0000 xFIR ~SIB|   ( Fits in the hole, requires also ~SIB, )
01A0 00,0000 0700,0000 0500,0000 xFIR [BP]   ( Fits in the hole, safe inconsistency check)
...
0110 00,0000 C000,0000 C000,0000 xFIR      R|
...
1002 04,0000 FF00 0069 2PI IMULI, ( 3)
1002 08,0000 FF00 006B 2PI IMULSI, ( 3)
...
1002 08,0000 FF,0000 T! 0800 00,A40F 0002 3FAMILY, SHLDI, SHRDI,    ( 3)
...
( --------- one fixup operands ----------)
0 04,0000 C701 00C6 2PI MOVI,
0012 0 0007 T!   0008 40 0004 1FAMILY, INC|X, DEC|X, PUSH|X, POP|X,
0012 0 0007 90 1PI XCHG|AX,
0011 04,0000 0007 B0 1PI MOVI|BR,
0012 04,0000 0007 B8 1PI MOVI|XR,
0 04,0000 C701 T!
...
0002 08,0000 C7,0000 T!  08,0000 20,BA0F 0004 3FAMILY, BTI, BTSI, BTRI, BTCI, ( 3)
...
0008 02,0000 0201 T!    0002 A0 0002 1FAMILY, MOV|TA, MOV|FA,
0 04,0000 0201 T!
...
0 10,0000 0201 T!   0002 E4 0002 1FAMILY, IN|P, OUT|P,
0 00,0000 0201 T!   0002 EC 0002 1FAMILY, IN|D, OUT|D,
0 00,0000 0201 T!   0002 6C 0002 1FAMILY, INS, OUTS,     ( 3)
...
0800 80,0000 5,0F00 800F 2PI J|X,                                           ( 3)
...
0001 04,0000 0000 T!    0001 D4 0002 1FAMILY, AAM, AAD,
0001 04,0000 0000 CD 1PI INT,
0008 22,0000 0000 9A 1PI CALLFAR,
0008 22,0000 0000 EA 1PI JMPFAR,
0 0100,0000 0000 T!   0008 C2 0002 1FAMILY, RET+, RETFAR+,
0004 80,0000 0000 T!   0001 E8 0002 1FAMILY, CALL, JMP,
0 40,0000 0000 EB 1PI JMPS,
0 40,0000 0000 T!   0001 E0 0004 1FAMILY, LOOPNZ, LOOPZ, LOOP, JCXZ,
0000 0 0000 T!
 ...
 0100 A80F 0002 2FAMILY, PUSH|GS, POP|GS, ( RSM,)
  0002 04,0000 0000   0068 1PI PUSHI|X,  ( 3)
  0001 04,0000 0000   006A 1PI PUSHI|B,  ( 3)
  0001 0104,0000 0000   00C8 1PI ENTER, ( 3)
